class Clip < ActiveRecord::Base
  ...
  validates_attachment_content_type :mp3, :content_type => [ 'application/mp3','application/x-mp3', 'audio/mpeg', 'audio/mp3', "audio/x-wav","audio/wav", 'application/wav', 'application/wav' ],
